                ...
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                    <div class="card-body p-5">
                        ...
                        <form action="index.php?act=login" method="post" class="needs-validation">
                            <div class="mb-3">
                                <label for="username" class="form-label small fw-semibold">Tên đăng nhập</label>
                                <input type="text" class="form-control py-2 bg-light border-0 <?= isset($login_errors['username']) ? 'is-invalid' : '' ?>" id="username" name="username" placeholder="Nhập tên đăng nhập" value="<?= isset($username) ? $username : '' ?>">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="password" class="form-control py-2 bg-light border-0 <?= isset($login_errors['password']) ? 'is-invalid' : '' ?>" id="password" name="password" placeholder="Nhập mật khẩu">
                            ...
                            <button type="submit" value="add" name="login" class="btn btn-primary w-100 py-2 fw-bold text-uppercase shadow-sm">Đăng nhập</button>
                        </form>
